                    ...
                    <div className="relative shrink-0">
                      ...
                      <div className="w-12 h-12 rounded-full overflow-hidden bg-white border-2 border-background">
                        <Avatar className="w-full h-full">
                          <AvatarImage
                            src={formatImageUrl(chat.other_user_img) || `https://api.dicebear.com/7.x/avataaars/svg?seed=${chat.other_user_id}`}
                      ...
                      <div className="absolute -right-2 -bottom-2">
                        <div className="w-10 h-10 rounded-lg overflow-hidden border-2 border-background">
                          <img
                            src={formatImageUrl(chat.product_thumbnail) || "https://placehold.co/100x100/e2e8f0/64748b?text=Product"}
                            alt="Product"
